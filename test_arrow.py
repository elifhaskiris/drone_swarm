...
def arm_and_takeoff(aTargetAltitude):
    ...
    while True:
        ...
        if vehicle5.location.global_relative_frame.alt>=aTargetAltitude*0.99: #Trigger just below target alt.
...
print("Arrow shape ",d, "m distance between drones")
DURATION = 20 #Set duration for each segment.

h=-h
y_offset=1
print("Point1")
goto_position_target_local_ned(vehicle, y_offset+(2*d),-(2*d*(math.cos(math.radians(30)))),h)

print("Point2")
goto_position_target_local_ned(vehicle2, y_offset+(d+d*(math.sin(math.radians(30)))),-(d*(math.cos(math.radians(30)))),h)

print("Point3")
goto_position_target_local_ned(vehicle3, y_offset+d,0,h)

print("Point4")
goto_position_target_local_ned(vehicle4, y_offset+(d*(math.sin(math.radians(30)))),-(d*(math.cos(math.radians(30)))),h)

print("Point5")
goto_position_target_local_ned(vehicle5, y_offset,-(2*d*(math.cos(math.radians(30)))),h)
time.sleep(DURATION)
