...
print("Triangle shape ",d,"m distance between each drones")
DURATION = 20 #Set duration for each segment.

print("point1")
goto_position_target_local_ned(vehicle, (y_offset+d*(math.sin(math.radians(60)))),-(x_offset+d/2),h)

print("point2")
goto_position_target_local_ned(vehicle2, y_offset,x_offset-d,h)

print("point3")
goto_position_target_local_ned(vehicle3, y_offset,x_offset,h)
time.sleep(DURATION)
