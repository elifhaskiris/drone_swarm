...
def arm_and_takeoff(aTargetAltitude):
    ...
    while True:
        print(" Altitude: ", vehicle6.location.global_relative_frame.alt)      
        if vehicle6.location.global_relative_frame.alt>=aTargetAltitude*0.95: #Trigger just below target alt.
            print("Reached target ",h,"m altitude")
            break
        time.sleep(1)
...
print("Pentagon shape ",d, "m distance between drones")
DURATION = 20 #Set duration for each segment.

h=-h
y_offset=1
print("Point1")
goto_position_target_local_ned(vehicle, y_offset+(2*d*(math.sin(math.radians(60)))),-(d*(math.cos(math.radians(60)))),h)

print("Point2")
goto_position_target_local_ned(vehicle2, y_offset+(2*d*(math.sin(math.radians(60)))),-(d+d*(math.cos(math.radians(60)))),h)

print("Point3")
goto_position_target_local_ned(vehicle3, y_offset+(d*(math.sin(math.radians(60)))),0,h)

print("Point4")
goto_position_target_local_ned(vehicle4, y_offset+(d*(math.sin(math.radians(60)))),-(2*d),h)

print("Point5")
goto_position_target_local_ned(vehicle5, y_offset,-(d*(math.cos(math.radians(60)))),h)

print("Point6")
goto_position_target_local_ned(vehicle6, y_offset,-(d+d*(math.cos(math.radians(60)))),h)
time.sleep(DURATION)
