...
def arm_and_takeoff(aTargetAltitude):
    ...
    while True:
        print(" Altitude: ", vehicle4.location.global_relative_frame.alt)      
        if vehicle4.location.global_relative_frame.alt>=aTargetAltitude*0.95: #Trigger just below target alt.
...
print("Square shape ",d, "m distance between drones")
DURATION = 20 #Set duration for each segment.

h=-h
y_offset=1
print("Point1")
goto_position_target_local_ned(vehicle, y_offset+d,-d,h)

print("Point2")
goto_position_target_local_ned(vehicle2, y_offset+d,0,h)

print("Point3")
goto_position_target_local_ned(vehicle3, y_offset,-d,h)

print("Point4")
goto_position_target_local_ned(vehicle4, y_offset,0,h)
