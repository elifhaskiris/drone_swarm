...
y_offset=0
print("Point1")
goto_position_target_local_ned(vehicle, y_offset+((d*(math.sin(math.radians(36))))+d*(math.sin(math.radians(72)))),-(d*(math.cos(math.radians(36)))),h)

print("Point2")
goto_position_target_local_ned(vehicle2, y_offset+(d*(math.sin(math.radians(72)))),0,h)

print("Point3")
goto_position_target_local_ned(vehicle3, y_offset+d*(math.sin(math.radians(72))),-(d*2*(math.cos(math.radians(36)))),h)

print("Point4")
goto_position_target_local_ned(vehicle4, y_offset,-(d*(math.cos(math.radians(72)))),h)

print("Point5")
goto_position_target_local_ned(vehicle5, y_offset,-(d+d*(math.cos(math.radians(72)))),h)
time.sleep(DURATION)
